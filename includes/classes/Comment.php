...
class Comment {
    ...
    public function __construct($con, $input, $userLoggedInObj, $videoId) {
        ...
        if (!is_array($input)) {
            ...
            //is input not sql data return id, and convert to sql data (ensure we get sql data)
            $input = $query->fetch(PDO::FETCH_ASSOC);
        }
        //if input is sql data return this
        $this->sqlData = $input;
        $this->con = $con;
    ...
    public function like() {
        ...
        if ($this->wasLikedBy()) {
            ...
            $query->execute();
              ...
              return 1 + $count; //add COUNT so that we can go from -1 to + 1 & vice versa on just one click of the like/dislike button
        }
    }
    ...
    public function dislike() {
        ...
        if ($this->wasDislikedBy()) {
            ...
            $query->execute();
              ...
              return -1 - $count; //add count so seamlessly jump between 1 to -1, -2, etc. if dislike
        }
    }
    ...
    public function getReplies() {
        ...
        //retrieve all comment replies from db and order by ascending
        ...
        //get all comment replies and output as string
