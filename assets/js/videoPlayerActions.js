...
//     req.open("POST", "ajax/likeVideo.php");
//     req.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded; charset=UTF-8');

//     req.onload = function() {
//         if (this.readyState == 4 && this.status == 200) {
//         } else {
//             alert("Oops, something went wrong. A team of monkeys has been dispatched to fix the problem at once!");
//         }
//     };
//     req.send(encodeURI('videoId=' + videoId));
// } ...
