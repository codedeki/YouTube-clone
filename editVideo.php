...
if (isset($_POST["saveButton"])) {
    ...
    if ($videoData->updateDetails($con, $video->getId())) {
        $detailsMessage = "<div class='alert alert-success'>
                                <strong>SUCCESS!</strong> Details updated succesfully!
                            </div>";
        $video = new Video($con, $_GET["videoId"], $userLoggedInObj); 
        //reupdate instance of our video class again so page changes without page refresh when user submits save
